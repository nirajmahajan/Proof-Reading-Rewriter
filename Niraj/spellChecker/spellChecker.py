...
pathDB = os.path.abspath('Niraj/data/dumps/Trigram-Bigram-Dictionary.db')
...
pathdic = os.path.abspath('Niraj/data/dumps/db.pickle')
with open(pathdic, 'rb') as handle:
    WORDS = pickle.load(handle)

pathfreq = os.path.abspath('Niraj/data/dumps/freq.pickle')
