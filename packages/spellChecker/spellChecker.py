...
import os
import re
from packages.spellChecker.helpers import *
...
pathDB = os.path.abspath('databases/data/dumps/Trigram-Bigram-Dictionary.db')
...
pathdic = os.path.abspath('databases/data/dumps/db.pickle')
with open(pathdic, 'rb') as handle:
    WORDS = pickle.load(handle)

pathfreq = os.path.abspath('databases/data/dumps/freq.pickle')
with open(pathfreq, 'rb') as handle:
